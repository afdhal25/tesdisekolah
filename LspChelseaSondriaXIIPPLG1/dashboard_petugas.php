<?php
session_start();  // Pastikan hanya sekali dipanggil di bagian atas

// Memastikan bahwa role sudah diset dan sesuai (case-insensitive)
if (!isset($_SESSION['role']) || strtolower($_SESSION['role']) !== 'petugas') {
...
// Cek apakah UserID sudah ada dalam sesi
